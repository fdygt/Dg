...
async def log_request(request: Request):
    logger.info(format_request_log(request))

async def log_response(request: Request, response: Response):
    logger.info(format_response_log(request, response))

def format_request_log(request: Request) -> str:
    return f"Request: {request.method} {request.url}"

def format_response_log(request: Request, response: Response) -> str:
    return f"Response: {request.method} {request.url} {response.status_code}"

...
class BalanceFilter(BaseModel):
    user_id: Optional[str] = Field(None, description="Filter berdasarkan ID user")
    min_balance: Optional[float] = Field(None, description="Saldo minimum")
    max_balance: Optional[float] = Field(None, description="Saldo maksimum")
    start_date: Optional[datetime] = Field(None, description="Tanggal awal transaksi")
    end_date: Optional[datetime] = Field(None, description="Tanggal akhir transaksi")
    currency: Optional[str] = Field(None, description="Kode mata uang (opsional)")

...
class UserActivity(BaseModel):
    timestamp: datetime = Field(..., description="Waktu aktivitas terjadi")
    user_id: str = Field(..., description="ID/Nama user")
    action: str = Field(..., description="Aksi yang dilakukan")
    details: Optional[str] = Field(None, description="Detail tambahan aktivitas")
